...
```
table Transplantion,  anti-fungal prescribed, development and type of cyclosporin toxicity and GVHD are illustrated in table. Age has been categorized to allow for risk stratification of patients.
...
Main question is finding the risk factors that affect ciclosporin level taking into account the longitudinal nature of the study.  
...
Here we are trying to find what factors affect the dose at which the patient will reach optimum ciclosporin plasma level. We are not considering the longitudinal nature of the study.
...
Here I am repeating the above steps, with the outcome variable divided into two levels only; dose <= 1.5 and dose > 1.5 
...
Although serum creat is significant, I have removed it from the model. This is because I have found the maximum serum creat is 0.8. Thus I thought that such fluctation within normal range won't affect the ciclosporin level. 
...
There is a high correlation between age and weight. I am planning for a solution to this as it can deteriorate model performance. 
...
is GVHD occurence related to days needed to reach optimum level?
...
When does ciclosporin toxicity occur?
...
It seems that the majority of patients develop toxocity within the first 30 days.
